function LevelManager(){
	...
	this.levelConfig={
		1: {
			holesOptions: {holesNum: 4, startAngle: Math.PI/6, holeAngle: Math.PI/12}
			// enemyOptions
		},
		2: {
			holesOptions: {holesNum: 3, startAngle: 0, holeAngle: Math.PI/14}
			// enemyOptions
		},
		3: {
		...
		6: {
			holesOptions: {holesNum: 1, startAngle: Math.PI/4, holeAngle: Math.PI/22},
			// enemyOptions:
		}
	}
}
